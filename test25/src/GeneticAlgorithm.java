...
public class GeneticAlgorithm {
     ...
     private int genes = 7; // Number of genes (weights)
     ...
     public double[][] chromosomes = new double [population][genes]; // Our chromosomes
     ...
     public  ArrayList<double[]> createGeneration () {
...
public double[][] sendWeightsToBot (double[][] chromosomes) {
